...
- Create a `.env` file using the `cp .env.example .env` command and replace the existing env variables with personal settings (MongoDB URL either `srv` or `localhost`)
	- Modify the connection string by modifying the following [line](https://github.com/kloudlot/nest-rest-mongo-boilerplate/blob/master/.env.sample#L10).
...
- Replace the following lines of code in the [main.ts file](https://github.com/kloudlot/nest-rest-mongo-boilerplate/blob/master/src/main.ts) with the ones detailed below.
...
The configuration for Swagger can be found at this [location](https://github.com/kloudlot/nest-rest-mongo-boilerplate/tree/master/src/swagger).
...
The configuration for Mongoose can be found in the [app module](https://github.com/kloudlot/nest-rest-mongo-boilerplate/blob/master/src/modules/app/app.module.ts#L17).

---

### 🔊 Logs

This boilerplate comes with an integrated Winston module for logging, the configurations for Winston can be found in the [app module](https://github.com/kloudlot/nest-rest-mongo-boilerplate/blob/master/src/modules/app/app.module.ts#L27).
